...
public class RecordController {
    ...
    public String findRecords(@RequestParam("surname") String surname, ModelMap modelMap) {
        modelMap.addAttribute("record", recordRepository.findBySurname(surname));
        return "records/list";
    }

    @RequestMapping(value = "/searchbyadress", method = RequestMethod.POST)
    public String findbyadress(@RequestParam("city") String city,
